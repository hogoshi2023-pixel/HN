    ...
    <>
            ...
            <div className="lg:col-span-7">
              <Reveal>
                <div className="flex items-center gap-3">
                  ...
                  <Eyebrow>Industrial Coatings Since 2003</Eyebrow>
                </div>
              </Reveal>
              ...
              <Reveal delay={80}>
                <h1 className="mt-5 text-4xl font-bold leading-[1.05] tracking-tight sm:text-5xl lg:text-6xl xl:text-7xl">
                  ...
                  <br />
                  for{" "}
                  <span className="text-brand">Heavy-Duty</span> Industries
                </h1>
              </Reveal>

              <Reveal delay={160}>
                <p className="mt-6 max-w-xl text-[15px] leading-relaxed text-muted-foreground sm:text-base">
                  ISO 9001 certified manufacturer of anti-corrosion,
                  high-temperature, epoxy floor, and architectural coatings.
                  Direct factory supply · OEM/ODM · Export to 60+ countries ·
              ...
              <Reveal delay={320}>
                <dl className="mt-12 grid grid-cols-2 gap-x-6 gap-y-6 sm:grid-cols-4">
                  {stats.map((s) => (
                    <div key={s.label} className="border-l border-border/70 pl-4">
      ...
      <div className="border-y border-border bg-background py-6">
        <div className="mx-auto max-w-7xl px-6">
          <p className="mb-4 text-center font-mono text-[11px] tracking-widest text-muted-foreground uppercase">
            Trusted by · Global B2B Partners
          </p>
        ...
        <div className="grid gap-10 lg:grid-cols-12 lg:items-start">
          <div className="lg:col-span-5">
            <SectionHeading
              ...
              title="Industrial Coatings. Engineered for B2B."
            />
          </div>
          <div className="lg:col-span-7">
            <p className="text-[15px] leading-relaxed text-muted-foreground">
              {company.name} manufactures and exports industrial paints,
              architectural coatings, and custom-engineered coating systems for
              factories, contractors, and OEM distributors worldwide.
            </p>
            <p className="mt-4 text-[15px] leading-relaxed text-muted-foreground">
              From anti-corrosion primers for offshore steel structures to
              high-temperature silicone coatings for power plants — every batch
              is backed by 22 years of formulation expertise, in-house QC labs,
              and full ISO 9001 traceability.
            </p>
            <div className="mt-6 flex flex-wrap gap-2">
              {["ISO 9001 Traceable", "In-house QC Lab", "OEM/ODM", "Export to 60+ countries"].map(
                (t) => (
                  <span
                    key={t}
      ...
      <Section className="bg-card/40 border-y border-border">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <SectionHeading
            ...
            title="Six Coating Systems. One Trusted Source."
          />
          <BrandButton variant="outline" onClick={() => navigate("products")}>
            View All Catalog <ArrowRight className="size-4" />
          </BrandButton>
        </div>
      ...
      <Section>
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <SectionHeading
            ...
            title="Field-proven across continents."
          />
      ...
      <Section className="bg-card/40 border-y border-border">
        <SectionHeading
          ...
          title="Audited. Tested. Documented."
          description="Every shipment backed by internationally recognized certifications. Pre-shipment samples can be tested at SGS, BV, or Intertek on request."
        />
