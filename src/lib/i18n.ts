...
export const ui: Record<string, LStr> = {
  ...
  "ap.titleAccent": { en: "China's coatings hometown.", zh: "中国涂料之乡。", vi: "quê hương sơn Trung Quốc." },
  "ap.titlePre": { en: "Since 2003, from", zh: "自2003年,立足", vi: "Từ 2003, tại" },
  "ap.desc": {
    en: "Founded in 2003, HONG NGUYEN is an integrated industrial-chemical enterprise combining anti-corrosion paint, industrial paint and architectural coating manufacturing with product solutions. Located in Shunde, Guangdong — known as China's coatings hometown — with modern facilities, advanced production and testing equipment, and a professional R&D team.",
    zh: "宏源成立于2003年,是一家以生产防腐漆、工业漆、建筑涂料生产,产品解决方案,工贸一体的化工企业,公司座落在有“中国涂料之乡”之称的广东顺德。拥有配备齐全的现代化厂房,先进的生产和检验设备以及专业的研发团队。",
    vi: "Thành lập năm 2003, HONG NGUYEN là doanh nghiệp hóa chất tích hợp sản xuất sơn chống ăn mòn, sơn công nghiệp, sơn kiến trúc cùng giải pháp sản phẩm, kết hợp công thương. Tọa lạc tại Shunde, Quảng Đông — được mệnh danh 'quê hương sơn Trung Quốc' — với nhà xưởng hiện đại, thiết bị sản xuất và kiểm nghiệm tiên tiến cùng đội ngũ R&D chuyên nghiệp.",
  },
  "ap.storyEyebrow": { en: "Company Profile", zh: "公司介绍", vi: "Giới thiệu công ty" },
  "ap.storyTitle": { en: "Quality-rooted, green development.", zh: "品质为本,绿色发展。", vi: "Chất lượng là gốc, phát triển xanh." },
  "ap.storyP1": {
    ...
    zh: "宏源成立于2003年,是一家以生产防腐漆、工业漆、建筑涂料生产,产品解决方案,工贸一体的化工企业,公司座落在有“中国涂料之乡”之称的广东顺德。拥有配备齐全的现代化厂房,先进的生产和检验设备以及专业的研发团队。",
    vi: "Thành lập năm 2003, HONG NGUYEN là doanh nghiệp hóa chất tích hợp sản xuất sơn chống ăn mòn, sơn công nghiệp, sơn kiến trúc cùng giải pháp sản phẩm, kết hợp công thương. Tọa lạc tại Shunde, Quảng Đông — 'quê hương sơn Trung Quốc' — với nhà xưởng hiện đại, thiết bị sản xuất và kiểm nghiệm tiên tiến, đội ngũ R&D chuyên nghiệp.",
  },
  "ap.storyP2": {
    en: "The company maintains long-term exchanges and cooperation with industry research institutions and universities. Each year it invests heavily in manpower and capital to inspect, update and upgrade production equipment, and strictly follows the ISO 9001 quality management system and ISO 14001 environmental management system for production and quality control.",
    zh: "企业长期与行业科研机构及各高等院校开展各种交流与合作,对于生产设备,企业更是每年花费大量的人力、财力,进行检测更新升级,并严格按照 ISO9001 质量管理体系和 ISO14001 环境管理体系进行生产和质量监控。",
    vi: "Công ty duy trì hợp tác lâu dài với các viện nghiên cứu và trường đại học. Hàng năm đầu tư lớn nhân lực và tài chính để kiểm tra, cập nhật, nâng cấp thiết bị sản xuất, tuân thủ nghiêm ngặt hệ thống quản lý chất lượng ISO 9001 và hệ thống quản lý môi trường ISO 14001 trong sản xuất và kiểm soát chất lượng.",
  },
  "ap.storyP3": {
    en: "Main products include the 'HONG NGUYEN' waterborne anti-corrosion paint series, solvent-borne anti-corrosion paint series, fluorocarbon paint, industrial paint, floor paint and specialty coatings. The range is complete, stable, high-quality and eco-friendly — widely used in steel structures, petrochemicals, bridges and ships, hardware and machinery, and construction.",
    zh: "公司主要产品有:“HONG NGUYEN” 水性防腐漆系列,油性防腐漆系列、氟碳漆、工业漆,地坪漆,特种涂料等,产品配套齐全、性能稳定、品质优异环保,广泛应用于钢结构、石油化工、桥梁船舶、五金机械、建筑等领域。",
    vi: "Sản phẩm chính gồm: sơn chống ăn mòn nước 'HONG NGUYEN', sơn chống ăn mòn dung môi, sơn fluorocarbon, sơn công nghiệp, sơn nền, sơn đặc thù. Đầy đủ chủng loại, ổn định, chất lượng cao, thân thiện môi trường — ứng dụng rộng rãi trong kết cấu thép, hóa dầu, cầu tàu, cơ kim, xây dựng.",
  },
  "ap.storyP4": {
    en: "HONG NGUYEN upholds the philosophy of quality-first and green development, continuously deepening its expertise in anti-corrosion coatings, optimizing product solutions and upgrading technical service. Looking ahead, HONG NGUYEN looks forward to partnering with customers worldwide for mutual benefit — providing reliable coatings and professional technical support to safeguard long-lasting anti-corrosion and green coating for every project.",
    zh: "公司始终坚守品质为本、绿色发展的经营理念,持续深耕防腐防护涂料领域,不断优化产品方案、升级技术服务。宏源新材料期待与各界客商携手同行、互利共赢,致力于为各类工程项目提供长效稳定、节能环保的涂装解决方案。",
    vi: "HONG NGUYEN kiên trì triết lý chất lượng là gốc, phát triển xanh, liên tục đào sâu lĩnh vực sơn chống ăn mòn, tối ưu giải pháp sản phẩm, nâng cấp dịch vụ kỹ thuật. HONG NGUYEN mong muốn hợp tác cùng khách hàng toàn cầu, cùng thắng, cam kết cung cấp giải pháp sơn bền vững, tiết kiệm năng lượng, thân thiện môi trường cho mọi công trình.",
  },
