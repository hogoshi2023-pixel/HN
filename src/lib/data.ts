...
export const products: Product[] = [
  {
    ...
    models: [
      { model: "HN-AC-201", desc: { en: "Epoxy zinc-rich primer — 80% zinc content, anti-corrosion base for steel", zh: "环氧富锌底漆——含锌量80%,钢结构防腐底漆", vi: "Lót epoxy giàu kẽm — 80% kẽm, lót chống ăn mòn cho thép" }, details: { en: `【产品概述】
...
2、易燃物品,远离火源,在施工范围内不宜吸烟。
3、储存在阴凉干爽的地方。` } },
      { model: "HN-AC-302", desc: { en: "High-build epoxy mid-coat — 200 μm DFT in single spray pass", zh: "高膜厚环氧中涂——单道喷涂 200 μm", vi: "Epoxy dày lớp giữa — 200 μm một lần phun" }, details: { en: `【产品概述】
宏源环氧富锌底漆是一种双组份富梓环氧底漆,本品为双组份化学固化干燥型,干漆膜中锌粉含量高达80％，其有优异的防腐蚀及耐磨损性能。
...
2、易燃物品,远离火源,在施工范围内不宜吸烟。
3、储存在阴凉干爽的地方。` } },
      { model: "HN-AC-405", desc: { en: "Acrylic polyurethane topcoat — UV-stable, 15-year gloss retention", zh: "丙烯酸聚氨酯面漆——抗紫外线,15年保光", vi: "Lớp phủ acrylic PU — chống UV, giữ bóng 15 năm" }, details: { en: `【产品概述】
宏源环氧富锌底漆是一种双组份富梓环氧底漆,本品为双组份化学固化干燥型,干漆膜中锌粉含量高达80％，其有优异的防腐蚀及耐磨损性能。
...
2、易燃物品,远离火源,在施工范围内不宜吸烟。
3、储存在阴凉干爽的地方。` } },
      { model: "HN-AC-501", desc: { en: "Glass-flake reinforced epoxy — chemical tank lining, immersion service", zh: "玻璃鳞片增强环氧——化学品罐内衬,浸渍环境", vi: "Epoxy vảy thủy tinh — lót bồn hóa chất, môi trường ngâm" }, details: { en: `【产品概述】
宏源环氧富锌底漆是一种双组份富梓环氧底漆,本品为双组份化学固化干燥型,干漆膜中锌粉含量高达80％，其有优异的防腐蚀及耐磨损性能。
...
3、储存在阴凉干爽的地方。` } }
  ...
  },
  {
    ...
    models: [
      { model: "HN-HT-200", desc: { en: "Silicone aluminum — 200°C continuous, exhaust pipes, heaters", zh: "有机硅铝粉漆——200°C 长期,排气管、加热器", vi: "Silicone nhôm — 200°C liên tục, ống xả, máy sưởi" }, details: { en: `【产品概述】
宏源环氧富锌底漆是一种双组份富梓环氧底漆,本品为双组份化学固化干燥型,干漆膜中锌粉含量高达80％，其有优异的防腐蚀及耐磨损性能。
...
3、储存在阴凉干爽的地方。` } },
  ...
  },
  {
    ...
    models: [
      { model: "HN-FL-101", desc: { en: "Self-leveling epoxy — 2–3 mm, glossy finish, light to medium traffic", zh: "自流平环氧——2–3 mm,亮光,中轻荷载", vi: "Epoxy tự chảy — 2–3 mm, bóng, tải nhẹ–trung" }, details: { en: `【产品概述】
宏源环氧富锌底漆是一种双组份富梓环氧底漆,本品为双组份化学固化干燥型,干漆膜中锌粉含量高达80％，其有优异的防腐蚀及耐磨损性能。
...
2、易燃物品,远离火源,在施工范围内不宜吸烟。
3、储存在阴凉干爽的地方。` } },
      { model: "HN-FL-202", desc: { en: "Anti-skid epoxy mortar — 4–6 mm, forklift-rated, R11–R13 slip", zh: "防滑环氧砂浆——4–6 mm,叉车承重,R11–R13", vi: "Vữa epoxy chống trượt — 4–6 mm, chịu xe nâng, R11–R13" }, details: { en: `【产品概述】
宏源环氧富锌底漆是一种双组份富梓环氧底漆,本品为双组份化学固化干燥型,干漆膜中锌粉含量高达80％，其有优异的防腐蚀及耐磨损性能。
...
2、易燃物品,远离火源,在施工范围内不宜吸烟。
3、储存在阴凉干爽的地方。` } },
      { model: "HN-FL-303", desc: { en: "Anti-static epoxy — 10⁶–10⁹ Ω, electronics & munitions plants", zh: "防静电环氧——10⁶–10⁹ Ω,电子及军工厂", vi: "Epoxy chống tĩnh điện — 10⁶–10⁹ Ω, nhà máy điện tử & quân cụ" }, details: { en: `【产品概述】
宏源环氧富锌底漆是一种双组份富梓环氧底漆,本品为双组份化学固化干燥型,干漆膜中锌粉含量高达80％，其有优异的防腐蚀及耐磨损性能。
...
2、易燃物品,远离火源,在施工范围内不宜吸烟。
3、储存在阴凉干爽的地方。` } },
      { model: "HN-FL-404", desc: { en: "Polyurethane concrete — thermal shock resistant, food-grade plants", zh: "聚氨酯混凝土——抗热冲击,食品级厂房", vi: "Bê tông polyurethane — chống sốc nhiệt, nhà máy thực phẩm" }, details: { en: `【产品概述】
宏源环氧富锌底漆是一种双组份富梓环氧底漆,本品为双组份化学固化干燥型,干漆膜中锌粉含量高达80％，其有优异的防腐蚀及耐磨损性能。
...
3、储存在阴凉干爽的地方。` } }
  ...
  },
  {
    ...
    models: [
      { model: "HN-EX-701", desc: { en: "PVDF fluorocarbon topcoat — AAMA 2605, 70% PVDF resin", zh: "PVDF 氟碳面漆——AAMA 2605,70% PVDF 树脂", vi: "Lớp phủ PVDF fluorocarbon — AAMA 2605, 70% PVDF" }, details: { en: `【产品概述】
宏源环氧富锌底漆是一种双组份富梓环氧底漆,本品为双组份化学固化干燥型,干漆膜中锌粉含量高达80％，其有优异的防腐蚀及耐磨损性能。
...
2、易燃物品,远离火源,在施工范围内不宜吸烟。
3、储存在阴凉干爽的地方。` } },
      { model: "HN-EX-702", desc: { en: "Acrylic polyurethane topcoat — high-gloss, color-stable", zh: "丙烯酸聚氨酯面漆——高光,保色", vi: "Lớp phủ acrylic PU — bóng cao, giữ màu" }, details: { en: `【产品概述】
宏源环氧富锌底漆是一种双组份富梓环氧底漆,本品为双组份化学固化干燥型,干漆膜中锌粉含量高达80％，其有优异的防腐蚀及耐磨损性能。
...
3、储存在阴凉干爽的地方。` } },
  ...
  },
  {
    ...
    models: [
      { model: "HN-AR-801", desc: { en: "Premium interior emulsion — anti-bacterial, stain-resistant, low odor", zh: "高级内墙乳胶——抗菌、抗污、低气味", vi: "Nhũ tương nội thất cao cấp — kháng khuẩn, chống bẩn, ít mùi" }, details: { en: `【产品概述】
宏源环氧富锌底漆是一种双组份富梓环氧底漆,本品为双组份化学固化干燥型,干漆膜中锌粉含量高达80％，其有优异的防腐蚀及耐磨损性能。
...
2、易燃物品,远离火源,在施工范围内不宜吸烟。
3、储存在阴凉干爽的地方。` } },
      { model: "HN-AR-802", desc: { en: "Exterior elastic anti-crack — bridges 1.5 mm cracks, weatherproof", zh: "外墙弹性抗裂——桥接 1.5 mm 裂纹,耐候", vi: "Ngoại thất đàn hồi chống nứt — che nứt 1.5 mm, chịu thời tiết" }, details: { en: `【产品概述】
宏源环氧富锌底漆是一种双组份富梓环氧底漆,本品为双组份化学固化干燥型,干漆膜中锌粉含量高达80％，其有优异的防腐蚀及耐磨损性能。
