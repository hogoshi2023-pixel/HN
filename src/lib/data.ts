...
export const products: Product[] = [
  {
    ...
    models: [
      { model: "HN-AC-201", desc: { en: "Epoxy zinc-rich primer — 80% zinc content, anti-corrosion base for steel", zh: "环氧富锌底漆——含锌量80%,钢结构防腐底漆", vi: "Lót epoxy giàu kẽm — 80% kẽm, lót chống ăn mòn cho thép" }, details: { en: "环氧富锌底漆P5160", zh: `【产品概述】
...
3、储存在阴凉干爽的地方。`, vi: "环氧富锌底漆P5160" } },
      { model: "HN-AC-302", desc: { en: "High-build epoxy mid-coat — 200 μm DFT in single spray pass", zh: "高膜厚环氧中涂——单道喷涂 200 μm", vi: "Epoxy dày lớp giữa — 200 μm một lần phun" }, details: { en: "环氧云铁中间漆", zh: `【产品概述】
...
3）贮存在阴凉干爽的地方。`, vi: "环氧云铁中间漆" } },
      { model: "HN-AC-405", desc: { en: "Acrylic polyurethane topcoat — UV-stable, 15-year gloss retention", zh: "丙烯酸聚氨酯面漆——抗紫外线,15年保光", vi: "Lớp phủ acrylic PU — chống UV, giữ bóng 15 năm" }, details: { en: "聚氨酯漆", zh: `【产品概述】
...
1）易燃物品，远离火源。在施工范围内不宜吸烟。
2）施工时必须保持空气流通，并采用一定的防护措施。避免吸入溶剂蒸气或漆雾，皮肤、眼睛不得接触本品。
3）贮存在阴凉干爽的地方。`, vi: "聚氨酯漆" } },
      { model: "HN-AC-501", desc: { en: "Glass-flake reinforced epoxy — chemical tank lining, immersion service", zh: "玻璃鳞片增强环氧——化学品罐内衬,浸渍环境", vi: "Epoxy vảy thủy tinh — lót bồn hóa chất, môi trường ngâm" }, details: { en: "环氧玻璃磷片漆", zh: `【产品概述】
...
【物理参数】
包装规格：漆料：25kg/桶 LS-11固化剂：2.5kg/桶`, vi: "环氧玻璃磷片漆" } }
    ],
  ...
  },
  {
    ...
    models: [
      { model: "HN-HT-200", desc: { en: "Silicone aluminum — 200°C continuous, exhaust pipes, heaters", zh: "有机硅铝粉漆——200°C 长期,排气管、加热器", vi: "Silicone nhôm — 200°C liên tục, ống xả, máy sưởi" }, details: { en: "有机硅耐高温漆", zh: `【产品概述】
...
4）本品仅限于专业用途。
备注：
本品受热后漆膜稍具热塑性，并光泽降低，施工时应避免太厚的漆膜，施工时必须稍加适量稀释剂以确保形成较低的干膜厚度。漆膜太厚会导致后来受热引起鼓泡，在高温使用时，漆膜总干膜厚度最好保持在75微米以下，漆膜未彻底干燥前（24h/20℃）不要受热。`, vi: "有机硅耐高温漆" } },
  ...
  },
  {
    ...
    models: [
      { model: "HN-FL-101", desc: { en: "Self-leveling epoxy — 2–3 mm, glossy finish, light to medium traffic", zh: "自流平环氧——2–3 mm,亮光,中轻荷载", vi: "Epoxy tự chảy — 2–3 mm, bóng, tải nhẹ–trung" }, details: { en: "自流平环氧地坪漆BF0565", zh: `【产品概述】
...
【安全守则】
本品仅适用于专业用途。小心使用本品，遵守安全事项的规定，如吞服请立即求医，避免吸入蒸气或漆雾，皮肤、眼睛不得接触本品，在通风良好的情况下施工，注意防火防爆。`, vi: "自流平环氧地坪漆BF0565" } },
      { model: "HN-FL-202", desc: { en: "Anti-skid epoxy mortar — 4–6 mm, forklift-rated, R11–R13 slip", zh: "防滑环氧砂浆——4–6 mm,叉车承重,R11–R13", vi: "Vữa epoxy chống trượt — 4–6 mm, chịu xe nâng, R11–R13" }, details: { en: "环氧地坪漆F5440", zh: `【产品概述】
...
1）施工时必须保持空气流通，并采用一定的防护措施，避免吸入溶剂蒸气或漆雾，皮肤、眼睛不得接触本品。
2）易燃物品，远离火源。在施工范围内不宜吸烟。
3）储存在阴凉干爽的地方。`, vi: "环氧地坪漆F5440" } },
      { model: "HN-FL-303", desc: { en: "Anti-static epoxy — 10⁶–10⁹ Ω, electronics & munitions plants", zh: "防静电环氧——10⁶–10⁹ Ω,电子及军工厂", vi: "Epoxy chống tĩnh điện — 10⁶–10⁹ Ω, nhà máy điện tử & quân cụ" }, details: { en: "水性环氧地坪漆E5440", zh: `【产品概述】
...
●普通喷涂：15%
●`, vi: "水性环氧地坪漆E5440" } },
      { model: "HN-FL-404", desc: { en: "Polyurethane concrete — thermal shock resistant, food-grade plants", zh: "聚氨酯混凝土——抗热冲击,食品级厂房", vi: "Bê tông polyurethane — chống sốc nhiệt, nhà máy thực phẩm" }, details: { en: "聚氨酯地坪漆", zh: `【产品概述】
...
3）储存在阴凉干爽的地方。`, vi: "聚氨酯地坪漆" } }
  ...
  },
  {
    ...
    models: [
      { model: "HN-EX-701", desc: { en: "PVDF fluorocarbon topcoat — AAMA 2605, 70% PVDF resin", zh: "PVDF 氟碳面漆——AAMA 2605,70% PVDF 树脂", vi: "Lớp phủ PVDF fluorocarbon — AAMA 2605, 70% PVDF" }, details: { en: "建筑氟碳漆", zh: `【产品概述】
...
1）易燃物品，远离火源。在施工范围内不宜吸烟。
2）施工时必须保持空气流通，并采用一定的防护措施。避免吸入溶剂蒸气或漆雾，皮肤、眼睛不得接触本品。
3）贮存在阴凉干爽的地方。`, vi: "建筑氟碳漆" } },
      { model: "HN-EX-702", desc: { en: "Acrylic polyurethane topcoat — high-gloss, color-stable", zh: "丙烯酸聚氨酯面漆——高光,保色", vi: "Lớp phủ acrylic PU — bóng cao, giữ màu" }, details: { en: "聚氨酯漆", zh: `【产品概述】
HONG NGUYEN（宏源）超级油霸面漆F5802是一种双组份聚氨酯涂料，具有优异的保光及保色性。本品具有优异的耐水，耐动、植物油，耐磨损，抗碰撞及抗紫外线的特点，适宜在中等至严重腐蚀环境下使用。
...
3）贮存在阴凉干爽的地方。`, vi: "聚氨酯漆" } },
  ...
  },
  {
    ...
    models: [
      { model: "HN-AR-801", desc: { en: "Premium interior emulsion — anti-bacterial, stain-resistant, low odor", zh: "高级内墙乳胶——抗菌、抗污、低气味", vi: "Nhũ tương nội thất cao cấp — kháng khuẩn, chống bẩn, ít mùi" }, details: { en: "内墙涂料", zh: `【产品概述】
...
4、施工时避免让漆刷或滚筒沾上吋霣油漆。
5、已稀释的油漆不要倒回原包装内。
6、请尽快用完开罐的产品。`, vi: "内墙涂料" } },
      { model: "HN-AR-802", desc: { en: "Exterior elastic anti-crack — bridges 1.5 mm cracks, weatherproof", zh: "外墙弹性抗裂——桥接 1.5 mm 裂纹,耐候", vi: "Ngoại thất đàn hồi chống nứt — che nứt 1.5 mm, chịu thời tiết" }, details: { en: "外墙涂料", zh: `【产品概述】
